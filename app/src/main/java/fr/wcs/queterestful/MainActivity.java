...
public class MainActivity extends AppCompatActivity {
    private final static String API_KEY = "f22802754acd230cf65251e648d5a052";
    @Override
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int l = 0; l < list.length(); l++) {
                                try {
                                    JSONObject daylist = (JSONObject) list.get(l);
                                    JSONArray weather = daylist.getJSONArray("weather");
